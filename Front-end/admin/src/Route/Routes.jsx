...
import TableListContain from "../Components/Application/Ecommerce/TableList";
...
export const routes = [
  ...
  {
    path: `${process.env.PUBLIC_URL}/app/project/meal/new-meal/:layout`,
    Component: <Newproject />,
  },
  {
  ...
  {
    path: `${process.env.PUBLIC_URL}/app/ecommerce/meal/meal-list/:layout`,
    Component: <ProductListContain />,
  },
  {
